...
const Navbar = () => {
    ...
    return (
        <header className="p-4 dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex justify-between h-10 w-[700px] mx-auto">
                ...
                <div className="flex items-center md:space-x-4">
                    ...
                    {
                        user ? <button onClick={handleLogOut} className="hidden px-6 py-2 font-semibold rounded lg:block dark:bg-red-400 dark:text-gray-900">Logout</button>
                            : <Link to='/authentication' className="hidden px-6 py-2 font-semibold rounded lg:block dark:bg-blue-400 dark:text-gray-900">Log in</Link>
                    }
                </div>
